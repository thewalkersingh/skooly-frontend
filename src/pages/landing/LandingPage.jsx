...
const FEATURES = [
   {
      ...
      desc: "Enroll, track, and manage every student's journey from admission to graduation."
   },
   {
      icon: Users,
      title: "Teacher Management",
      desc: "Manage staff profiles, subjects, and class assignments in one place."
   },
   {
      icon: ClipboardList,
      title: "Attendance Tracking",
      desc: "Bulk mark attendance by class and date. View history and summary reports instantly."
   },
   {
      icon: BookOpen,
      title: "Library System",
      desc: "Track book inventory, issue and return records with availability at a glance."
   },
   {
      icon: CreditCard,
      title: "Fees & Finance",
      desc: "Define fee structures, record payments, and monitor collection summaries."
   },
   {
      icon: BarChart3,
      title: "Analytics Dashboard",
      desc: "Visual insights into school performance, attendance rates, and financials."
   },
];
...
const STEPS = [
   {
      ...
      desc: "Register your institution and set up classes, sections, and subjects."
   },
   {
      n: "02",
      title: "Add your people",
      desc: "Onboard teachers, enroll students, and assign them to the right classes."
   },
   {
      n: "03",
      title: "Run your school",
      desc: "Mark attendance, manage the library, collect fees — all from one dashboard."
   },
];
